...
3. **Validação Zero-Shot de Modelos de Linguagem:** Benchmark comparativo (Llama 3 8B, Llama 3.1 8B, Gemma 2 27B) e análise das fragilidades (*Zero-Shot Positive Bias*).
